...
public class VerificationService {
    ...
    // i added this to get count of new verifications
    ...
    public Page<Verification> findPageOfSentVerificationsByCalibratorId(
            Long calibratorId, int pageNumber, int itemsPerPage) {
        Pageable pageRequest = new PageRequest(pageNumber - 1, itemsPerPage);
        System.out.println("inside usual method");
     ...
     */
    @Transactional
    public void updateVerificationByProvider(String verificationId, Calibrator calibrator) {
